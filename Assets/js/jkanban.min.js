  ...
  this.jKanban = function () {
      ...
      for (var boardkey in boards) {
        ...
        if(board.total_pages > 1) {
          ...
          if(board.current_page > 1) {
            navHtml += '<button class="kanban-board-nav-prev btn btn-default btn-xs pull-left" data-boardKey="'+boardkey+'"><span class="fa fa-arrow-left"></span></button>'
          }
          if(board.current_page < board.total_pages) {
            navHtml += '<button class="kanban-board-nav-next btn btn-default btn-xs pull-right" data-boardKey="'+boardkey+'"><span class="fa fa-arrow-right"></span></button>'
          }
    ...
    function __buildItemCard(item) {
      ...
      if(item.creator.trim() != ""){
        result += '<div class="kanban-item-creator text-right small"><b>'+mauticLang['plugin.powerticpipes.createdBy']+':</b> <span>'+item.creator+'</span></div>';
      }
      
      if(typeof item.lead != 'undefined'){
        if(cardColumns.indexOf('lead.name') > -1 && item.lead.name != '' && item.lead.name != ' ' && item.lead.name != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.contact']+':</b> <span>'+item.lead.name+'</span></div>';
        }
        if(cardColumns.indexOf('lead.email') > -1 && item.lead.email != '' && item.lead.email != ' ' && item.lead.email != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.email']+':</b> <span>'+item.lead.email+'</span></div>';
        }
        if(cardColumns.indexOf('lead.company') > -1 && item.lead.company != '' && item.lead.company != ' ' && item.lead.company != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.company']+':</b> <span>'+item.lead.company+'</span></div>';
        }

        if(cardColumns.indexOf('lead.points') > -1 && item.lead.points != '' && item.lead.points != ' ' && item.lead.points != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.points']+':</b> <span>'+item.lead.points+'</span></div>';
        }

        if(cardColumns.indexOf('lead.position') > -1 && item.lead.position != '' && item.lead.position != ' ' && item.lead.position != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.position']+':</b> <span>'+item.lead.position+'</span></div>';
        }

        if(cardColumns.indexOf('lead.phone') > -1 && item.lead.phone != '' && item.lead.phone != ' ' && item.lead.phone != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.phone']+':</b> <span>'+item.lead.phone+'</span></div>';
        }

        if(cardColumns.indexOf('lead.mobile') > -1 && item.lead.mobile != '' && item.lead.mobile != ' ' && item.lead.mobile != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.mobile']+':</b> <span>'+item.lead.mobile+'</span></div>';
        }

        if(cardColumns.indexOf('lead.address') > -1 && item.lead.address != '' && item.lead.address != ' ' && item.lead.address != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.address']+':</b> <span>'+item.lead.address+'</span></div>';
        }

        if(cardColumns.indexOf('lead.country') > -1 && item.lead.country != '' && item.lead.country != ' ' && item.lead.country != null){
          result += '<div class="kanban-item-lead text-right small"><b>'+mauticLang['plugin.powerticpipes.country']+':</b> <span>'+item.lead.country+'</span></div>';
        }
      }
      if(cardColumns.indexOf('powertic_pipes_cards.date_added') > -1){
        result += '<div class="kanban-item-date_added text-right small"><b>'+mauticLang['plugin.powerticpipes.card.date_added']+':</b> '+item.date_added+'</div>';
      }
      if(cardColumns.indexOf('powertic_pipes_cards.value') > -1 && item.value != '' && item.value != null){
        result += '<div class="kanban-item-value text-right small"><b>'+mauticLang['plugin.powerticpipes.card.value']+':</b> '+item.value+'</div>';
      }
      result += '<div class="kanban-item-date text-right small"><b>'+mauticLang['plugin.powerticpipes.update_date']+':</b> '+item.date+'</div>';
