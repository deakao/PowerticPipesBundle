  ...
  this.jKanban = function () {
    ...
    this.addBoards = function (boards, isInit) {
      ...
      for (var boardkey in boards) {
        ...
        totals.innerHTML = '<div class="kanban-totals"><span class="pull-left total_value">'+(board.total_value ? mauticLang['plugin.powerticpipes.currency_code']+number_format(board.total_value, 2, ',', '.') : '')+'</span> <span class="pull-right total_items">' +number_format(board.total_items, 0, '', '.')+ ' '+mauticLang['plugin.powerticpipes.prospects']+'</span></div>';
